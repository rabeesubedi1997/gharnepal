...
use App\Http\Controllers\Api\V1\Public\AssistantController;
...
Route::prefix('v1')->group(function () {
    ...
    // Natural-language property search assistant — rule-based parsing, no
    // paid AI API (see PropertySearchParser). Guest-friendly, own throttle.
