...
export function AlertSignupBanner() {
  ...
  return (
    // Full-bleed to the viewport edge (see Home.tsx's hero for the same
    // pattern) so the dark band fills a wide monitor instead of sitting in
    // a boxed strip with plain background on either side.
    <section className="full-bleed bg-ink-900 text-white">
      <div className="mx-auto flex max-w-[1440px] flex-col gap-4 px-4 py-8 sm:px-6 sm:py-10 lg:flex-row lg:items-center lg:justify-between lg:px-10">
